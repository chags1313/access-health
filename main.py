...
def main(page: ft.Page):
    ...
    def create_chart_card(x, y, type_text, value_text):
        data_list = []
        ...
        value_txt = ft.Text("Range: " + value_text[0], color = ft.colors.BLUE_100, size = 24)
        values = ft.Row(controls=[
            ft.Text("Min: " + value_text[1], color = ft.colors.BLUE_100, size = 10),
            ft.Text("Max: " + value_text[2], color = ft.colors.BLUE_100, size = 10)])
